...
export default function UserDashboard() {
    ...
    function handleAddEdit(todoKey) {
        return () => {
          console.log(`"${todos[todoKey]}" todo-item is currently under editing ...`)
          setEdit(todoKey)
            ...
            {(!loading) && (
                <>
                    {Object.keys(todos).map((todo, i) => {
                        return (
                            <TodoCard handleEditTodo={handleEditTodo}
                                key={i} handleAddEdit={handleAddEdit}
                                edit={edit} todoKey={todo}
